...
export class Test {
    ...
    showQuestion() {
        ...
        this.passButtonElement.innerHTML = 'Пропустить вопрос <img src="/images/test_arrow.png" class="common__arrow" alt="test_arrow">';
        const that = this;
    ...
    chooseAnswer() {
        ...
        this.passButtonElement.innerHTML = 'Пропустить вопрос <img src="/images/arrow_gray.png" class="common__arrow" alt="test_arrow">';
    }
